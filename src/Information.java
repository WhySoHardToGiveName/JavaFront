...
public class Information extends JPanel {
    ...
    private void addListener() {
        ...
        footballLabel.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                new GymIntro("足球", "src/img/football2.jpg", "9：00-21:00", "是", 3, 1, 20,
        ...
        tennisLabel.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                new GymIntro("网球", "src/img/tennis2.jpg", "9：00-21:00", "否", 3, 2, 4,
        ...
        volleyballLabel.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                new GymIntro("排球", "src/img/volleyball2.jpg", "9：00-21:00", "是", 3, 1, 15,
