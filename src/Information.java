    ...
    private void addListener() {
        badmintonLabel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                new GymIntro("羽毛球场", "src/img/badminton.jpg", "9：00-21:00", "否", 8, 2, 4,
        ...
        basketballLabel.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                new GymIntro("篮球场", "src/img/basketball2.jpg", "9：00-21:00", "是", 8, 1, 10,
        ...
        footballLabel.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                new GymIntro("足球场", "src/img/football2.jpg", "9：00-21:00", "是", 3, 1, 20,
        ...
        tennisLabel.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                new GymIntro("网球场", "src/img/tennis2.jpg", "9：00-21:00", "否", 3, 2, 4,
        ...
        volleyballLabel.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                new GymIntro("排球场", "src/img/volleyball2.jpg", "9：00-21:00", "是", 3, 1, 15,
        ...
        tabletennisLabel.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                new GymIntro("乒乓球场", "src/img/tabletennis2.jpg", "9：00-21:00", "否", 8, 2, 4,
